"""Deterministic ATK generator for the eight recurrent_kda CPU/GPU cases."""
...
@GENERATOR_REGISTRY.register("generator_recurrent_kda_gpu")
class RecurrentKdaGpuGenerator(CaseGenerator):
    """Force case generation to cover the requested Cartesian product."""
